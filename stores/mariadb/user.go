...
func (u User) Create(user models.User) (int64, error) {
	...
	stmt, err = db.PrepareContext(ctx, fmt.Sprintf(`INSERT INTO %s SET (user_employee_id, user_name, user_address, user_telephone, user_created_at, user_updated_at)VALUES(?,?,?,?,?,?,?,?)`, u.TableName))
	if err != nil {
		return 0, err
	}
